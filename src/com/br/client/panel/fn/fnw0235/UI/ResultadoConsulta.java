...
import com.br.client.panel.fn.fnw0235.model.EPlanoContas;
...
//					}
		...
		formBean.setSubTitle("Centro de Custo / Conciliação");
		formBean.setModulo("FNW0235");
		
		struts.request("fnw0217.do?method="+metodo, "FNW0217Form", formBean.toSendBody(""));
	}
