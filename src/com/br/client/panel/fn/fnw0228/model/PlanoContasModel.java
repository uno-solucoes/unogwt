package com.br.client.panel.fn.fnw0228.model;
...
public class PlanoContasModel {
	...
	// Remoção solicitada pelo Marcio
	// 95  - Sem Previsão
	// 100 - Perdido
	String situacoesValidasAtrasos = "5,10,15,20,30,35"; 
	String situacoesValidas        = "5,10,15,20,30,35,95,100";	
	...
	protected String getSelectTitulosVencimento(String dataInicio, String dataFim, String tipoGrupo){
		...
		sql += "        sum( ( tipa.vl_total_titulo ) "+getCentroCustoPercRateio()+" ) as valor\n";
		sql += "FROM\n";
	    ...
	    sql += "	tipa.situacao IN( "+this.getSituacoesValidas()+" )\n";
	...
	/**
	 * @return the situacoesValidasAtrasos
	 */
	public String getSituacoesValidasAtrasos() {
		return situacoesValidasAtrasos;
	}
	...
	/**
	 * @param situacoesValidasAtrasos the situacoesValidasAtrasos to set
	 */
	public void setSituacoesValidasAtrasos(String situacoesValidasAtrasos) {
		this.situacoesValidasAtrasos = situacoesValidasAtrasos;
	}
	...
	/**
	 * @return the situacoesValidas
	 */
	public String getSituacoesValidas() {
		return situacoesValidas;
	}
 
	/**
	 * @param situacoesValidas the situacoesValidas to set
	 */
	public void setSituacoesValidas(String situacoesValidas) {
