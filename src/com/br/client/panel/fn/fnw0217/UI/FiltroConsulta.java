...
//	private HowMGWTDateItem fieldMesReferenciaFinal   = new HowMGWTDateItem("mesReferenciaFinal"      , Tradutor.i18n.mesDataCorteFinal());
	...
	private HowMGWTProperty propertyTpPlanoConta	= new HowMGWTProperty("tpPlanoConta", "Tp Plano Conta");
	...
	public HowMGWTProperty getPropertyTpPlanoConta() {
		return propertyTpPlanoConta;
	}
...
//		this.fieldMesReferenciaFinal.getField().setWidth(90);
		...
		// -------------------------------------------------------------------------
		propertyTpPlanoConta.setBound(100, 100);		
		propertyTpPlanoConta.createHowMGWTFormFieldSelectItem();
		hLayoutChecks.addMember( propertyTpPlanoConta.getCanvas() );
		configureTpPlanoConta();
		
		propertyTpPlanoConta.setHowmFormValue("0");
...
//	}
	...
	public void configureTpPlanoConta(){
		LinkedHashMap< String , String > mapTipos = new LinkedHashMap<String, String>();
		mapTipos.put("0", "");
		mapTipos.put("1", "Fixa");
		mapTipos.put("2", "Vari&aacute;vel");
		this.propertyTpPlanoConta.getHowMGWTEditorSelectItem().getField().setValueMap(mapTipos);
		this.propertyTpPlanoConta.setHowmFormValue(Configuracao.getTpPlanoConta());
	}
