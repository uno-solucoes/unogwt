...
public class UCFieldSituacaoColaborador extends HowMGWTSelectItem{

	private LinkedHashMap< String, String > situacoes = new LinkedHashMap<String, String>();
	
	public UCFieldSituacaoColaborador(){
		this.getField().setName("situacaoColaborador");
	...
	public void start(){
		...
		entity.setAction(Services.acaoListaSituacoesColaborador);
