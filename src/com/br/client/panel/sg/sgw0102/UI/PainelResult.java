...
//	public void showRecords(HowMGWTFormBean formBean, eDiretorioGED diretorio){
//		FormBean bean = (FormBean)formBean;
//		
//		eArquivoGED[] arquivos = bean.getArquivoGEDs();
//		
...
// 
//				record.setAttribute("DIRETORIO", diretorio);
//				
//				record.setAttribute("ARQUIVO", arquivo);
//				record.setAttribute(fieldArquivo.getName(), arquivo.getNomeArquivo());
