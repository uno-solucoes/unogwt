...
public class eNopArquivo extends com.howmake.client.form.model.HowMGWTFormBean{
	public eNopArquivo(){
	}
	...
	public static final com.br.client.model.cd.entity.eNopArquivo newInstance(){
		return new com.br.client.model.cd.entity.eNopArquivo();
	}
}