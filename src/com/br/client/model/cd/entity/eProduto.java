...
public class eProduto extends com.howmake.client.form.model.HowMGWTFormBean{
	public eProduto(){
	}
	...
	public static final com.br.client.model.cd.entity.eProduto newInstance(){
		return new com.br.client.model.cd.entity.eProduto();
	}
}