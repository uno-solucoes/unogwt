...
public class HowMGWTFormComboBox extends DynamicForm implements HowMGWTFormField{
	
	private ComboBoxItem field = new ComboBoxItem();

	public HowMGWTFormComboBox(){		
		this.setItems(this.field);
		this.getField().setPickListHeight(200);
		this.getField().setPickListWidth(300);		
 	}
	
	public HowMGWTFormComboBox(String name, String title){
		this();
