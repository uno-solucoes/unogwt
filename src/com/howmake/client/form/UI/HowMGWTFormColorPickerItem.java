...
public class HowMGWTFormColorPickerItem extends DynamicForm implements HowMGWTFormField{

	private ColorPickerItem field = new ColorPickerItem();

	public HowMGWTFormColorPickerItem(){		
		this.setItems(this.field);
	}
	public HowMGWTFormColorPickerItem(String name, String title){
		this();
	 ...
	 * @return the field
	 */
	public ColorPickerItem getField() {
		return field;
	}
	/**
	 * @param field the field to set
	 */
	public void setField(ColorPickerItem field) {
		this.field = field;
	}
